...
export const getQN: (obj: K8sResourceKind) => string = ({
...
//   }api/kubernetes`;
// export const k8sBasePath = "https://192.168.6.169:6443";
export const k8sBasePath = `${document.location.origin}/api/kubernetes`;
