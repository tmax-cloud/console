      ...
      <React.Fragment>
        ...
        <div id="content">
          ...
          <Switch>
            ...
            {/* <LazyRoute path="/k8s/ns/:ns/rolebindingclaims/new/:type" exact kind="RoleBindingClaim" loader={() => import('./roleBindingClaims/create-namespaceClaim').then(m => m.CreateNamespaceClaim)} /> */}
