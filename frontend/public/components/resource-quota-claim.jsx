        ...
        <div className="row">
          ...
          <div className="col-sm-6">
            <dl className="co-m-pane__details">
              ...
              {resourcequotaclaim.status && resourcequotaclaim.status.status === 'Reject' && <dt>Reason</dt>}
              {resourcequotaclaim.status && resourcequotaclaim.status.status === 'Reject' && <dd>{resourcequotaclaim.status.reason}</dd>}
