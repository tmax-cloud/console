...
const Header = props => {
  ...
  return <ListHeader>
    <ColHead {...props} className="col-md-5 col-xs-6" sortField="metadata.name">{t('CONTENT:NAME')}</ColHead>
    <ColHead {...props} className="col-md-7 col-xs-6" sortField="metadata.namespace">{t('CONTENT:NAMESPACE')}</ColHead>
  </ListHeader>
};
