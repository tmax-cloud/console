...
export const namespacedPrefixes = ['/api-resource', '/catalog', '/k8s', '/operatorhub', '/operatormanagement', '/operators', '/details', '/provisionedservices', '/search', '/status', '/helmreleases2'];
