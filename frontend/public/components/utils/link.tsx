...
export const namespacedPrefixes = ['/api-resource', '/catalog', '/k8s', '/operatorhub', '/operatormanagement', '/operators', '/details', '/provisionedservices', '/search', '/status', '/helmreleases', '/helmreleases2'];
...
export const HyperCloudManualLink = "https://technet.tmaxsoft.com/upload/download/online/hypercloud/pver-20210701-000002/hypercloud/21-ko/welcome/intro.html";
