...
const ListDropdown_ = withTranslation()(
  class ListDropdown_ extends React.Component {
    ...
    render() {
      ...
      return (
        <div>
          {Component}
          {loaded && _.isEmpty(items) && <Alert isInline className="co-alert pf-c-alert--top-margin" variant="info" title={t('SINGLE:MSG_DEPLOYMENTS_EDITDEPLOYMENTS_ADDSTORAGE_6', { 0: desc })} />}
        </div>
      );
    }
  },
