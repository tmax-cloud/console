...
export const NavTitle = connectToModel((props: NavTitleProps) => {
  const { kind, kindObj, detail, title, menuActions, obj, breadcrumbsFor, style, tooltipTitle, tooltipContentsElements } = props;
  ...
  return (
    <div className={classNames('co-m-nav-title', { 'co-m-nav-title--detail': detail }, { 'co-m-nav-title--logo': isCSV }, { 'co-m-nav-title--breadcrumbs': breadcrumbsFor && !_.isEmpty(data) })} style={style}>
