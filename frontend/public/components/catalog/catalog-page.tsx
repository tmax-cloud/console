    ...
    return _.reduce(
      ...
      (acc, serviceClass) => {
        ...
        acc.push({
          ...
          href: `/k8s/ns/${namespace}/serviceinstances/~new?service-class=${serviceClass.spec.externalName}`,
    ...
    return _.reduce(
      ...
      (acc, clusterServiceClass) => {
        ...
        acc.push({
          ...
          href: `/k8s/ns/${namespace}/serviceinstances/~new?cluster-service-class=${clusterServiceClass.spec.externalName}`,
