...
export const StatefulSetsPage = props => {
  ...
  return <ListPage {...props} ListComponent={StatefulSetsList} kind={kind} canCreate={true} createProps={createProps} createButtonText={t('ADDITIONAL:CREATEBUTTON', { something: ResourcePlural('StatefulSet', t) })} />;
};
