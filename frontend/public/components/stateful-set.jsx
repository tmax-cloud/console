...
export const StatefulSetsPage = props => {
  ...
  return <ListPage {...props} ListComponent={StatefulSetsList} kind={kind} createProps={createProps} canCreate={true} createButtonText={t('ADDITIONAL:CREATEBUTTON', { something: ResourcePlural('StatefulSet', t) })} />;
};
