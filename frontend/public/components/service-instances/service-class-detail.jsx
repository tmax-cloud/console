  ...
  return (
    <div style={{ height: '528px', width: '970px' }}>
      ...
      <div style={{ position: 'relative', height: '426px' }}>
        ...
        {/* iframe 영역위에 닫기버튼 (혹은 워터마크 등) 을 position: absolute; z-index:9999 등으로 작업 할 때에 ie 나 firefox 에서는 위 버튼이 보이지 않습니다. 그럴땐 iframe의 src 값에 wmode=transparent 를 추가하고 iframe 의 attribute 에 wmode="Opaque" 를 추가합니다.*/}
        ...
        {urlDescription !== '' && (
          <iframe style={{ width: '100%', height: '430px' }} src={urlDescription} target="_blank">
            {urlDescription}
