...
export const PipelineApprovalsPage = props => {
  const { t } = useTranslation();
  return <ListPage {...props} ListComponent={PipelineApprovalList} canCreate={true} kind="Approval" createButtonText={t('ADDITIONAL:CREATEBUTTON', { something: ResourcePlural(props.kind, t) })} />;
};
