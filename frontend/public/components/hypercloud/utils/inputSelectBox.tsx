...
export const InputSelectBox: React.FC<InputSelectProps> = props => {
  ...
  return (
    <div className="pf-c-input-group">
      ...
      <Controller as={Dropdown} control={control} selectedKey={selectedKey} name={dropdownName} className="btn-group" defaultValue={selectedKey} items={items} required={required} />
    </div>
  );
};
