...
const DropdownMainButton = ({ label, toggleOpen, count = 0, buttonWidth, isAll = false }) => {
  return (
    <div className="hc-dropdown-main-button" style={{ width: buttonWidth }} onClick={toggleOpen}>
      ...
      <span className="pf-c-badge pf-m-read">{isAll ? 'All' : count}</span>
...
/**
 * 다중선택이 가능하고 item 선택 시 드롭다운 하위에 chip의 형태로 선택된 항목이 나타난다. 제거는 chip 에서만 할 수 있다.
