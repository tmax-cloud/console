...
export const hyperCloudDetailsPages = ImmutableMap<ResourceMapKey, ResourceMapValue>()
  ...
  .set(referenceForModel(KafkaClusterModel), () => import('./kafkacluster' /* webpackChunkName: "kafkabroker" */).then(m => m.KafkaClustersDetailsPage))
...
export const hyperCloudListPages = ImmutableMap<ResourceMapKey, ResourceMapValue>()
  ...
  .set(referenceForModel(KafkaClusterModel), () => import('./kafkacluster' /* webpackChunkName: "kafkabroker" */).then(m => m.KafkaClustersPage))
