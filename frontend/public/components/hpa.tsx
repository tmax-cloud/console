...
const MetricsTable: React.SFC<MetricsTableProps> = ({ obj: hpa }) => {
  ...
  return (
    <React.Fragment>
      <SectionHeading text={t('CONTENT:METRICS')} />
      <div className="co-m-table-grid co-m-table-grid--bordered">
        <div className="row co-m-table-grid__head">
          <div className="col-xs-6">{t('CONTENT:TYPE')}</div>
          <div className="col-xs-3">{t('CONTENT:CURRENT')}</div>
          <div className="col-xs-3">{t('CONTENT:TARGET')}</div>
        </div>
  ...
  return (
    <React.Fragment>
      <div className="co-m-pane__body">
        <SectionHeading text={t('ADDITIONAL:OVERVIEWTITLE', { something: ResourcePlural('HorizontalPodAutoscaler', t) })} />
        <div className="row">
          ...
          <div className="col-sm-6">
            <dl className="co-m-pane__details">
              ...
              <dt>{t('CONTENT:MINPODS')}</dt>
              <dd>{hpa.spec.minReplicas}</dd>
              <dt>{t('CONTENT:MAXPODS')}</dt>
...
const HorizontalPodAutoscalersRow: React.SFC<HorizontalPodAutoscalersRowProps> = ({ obj }) => (
