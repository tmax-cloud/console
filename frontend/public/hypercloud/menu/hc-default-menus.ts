...
const MasterNavMenus = [
  {
    ...
    innerMenus: [CustomMenusMap.Dashboard.kind, Models.NamespaceModel.kind, CustomMenusMap.Search.kind, CustomMenusMap.Audit.kind, CustomMenusMap.Events.kind, CustomMenusMap.ArgoCD.kind, CustomMenusMap.Grafana.kind, CustomMenusMap.Git.kind, CustomMenusMap.Harbor.kind],
  },
  {
    menuType: MenuType.CONTAINER,
