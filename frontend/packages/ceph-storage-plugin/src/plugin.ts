...
import { ClusterServiceVersionAction, DashboardsCard, DashboardsOverviewHealthResourceSubsystem, DashboardsOverviewUtilizationItem, DashboardsTab, KebabActions, ModelDefinition, ModelFeatureFlag, Plugin, ResourceTabPage, RoutePage, ResourceDetailsPage, DashboardsOverviewResourceActivity, CustomFeatureFlag } from '@console/plugin-sdk';
import { CEPH_FLAG, OCS_INDEPENDENT_FLAG, OCS_SUPPORT_FLAGS, OCS_CONVERGED_FLAG } from './features';
...
type ConsumedExtensions = ModelFeatureFlag | ModelDefinition | DashboardsTab | DashboardsCard | DashboardsOverviewHealthResourceSubsystem<WatchCephResource> | DashboardsOverviewUtilizationItem | RoutePage | CustomFeatureFlag | ClusterServiceVersionAction | KebabActions | ResourceDetailsPage | ResourceTabPage | ClusterServiceVersionAction | KebabActions | DashboardsOverviewResourceActivity;
...
const plugin: Plugin<ConsumedExtensions> = [
  ...
  },
  {
    ...
    properties: {
      ...
      loader: async () => import('./components/volume-snapshot/volume-snapshot' /* webpackChunkName: "ceph-storage-volume-snapshot-details" */).then(m => m.VolumeSnapshotDetails),
