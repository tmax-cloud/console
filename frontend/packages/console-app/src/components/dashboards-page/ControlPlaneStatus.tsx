...
const ControlPlanePopup: React.FC<PrometheusHealthPopupProps> = ({ responses }) => {
  ...
  const titles = [t('SINGLE:MSG_OVERVIEW_MAIN_POPOVERCONTROLPLANE_APISERVERS_1'), t('SINGLE:MSG_OVERVIEW_MAIN_POPOVERCONTROLPLANE_CONTROLLER_1'), t('SINGLE:MSG_OVERVIEW_MAIN_POPOVERCONTROLPLANE_SCHEDULERS_1'), t('SINGLE:MSG_OVERVIEW_MAIN_POPOVERCONTROLPLANE_APIREQUEST_1'), t('SINGLE:MSG_OVERVIEW_MAIN_POPOVERCONTROLPLANE_ETCD_1')];
  return (
    <>
