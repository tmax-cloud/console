...
export class TransformResourceData {
  ...
  public createStatefulSetItems = (statefulSets: K8sResourceKind[], operatorsFilter?: boolean): OverviewItem[] => createStatefulSetItems(statefulSets, this.resources, this.installedOperators, this.utils, operatorsFilter);
