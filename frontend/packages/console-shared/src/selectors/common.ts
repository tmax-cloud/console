...
import { K8sResourceCommon } from '../../../../public/module/k8s';
...
export const getUID = <A extends K8sResourceCommon = K8sResourceCommon>(
  value: A
...
>(
  ...
  ) as K8sResourceCommon['metadata']['deletionTimestamp'];
export const getCreationTimestamp = <
  A extends K8sResourceCommon = K8sResourceCommon
>(
  value: A
) =>
  ...
  ) as K8sResourceCommon['metadata']['creationTimestamp'];
