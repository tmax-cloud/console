 ...
 */
export const OperandYAML: React.FC<OperandYAMLProps> = ({ match, onChange, next, initialYAML = '' }) => {
  return <CreateYAML hideHeader match={match} onChange={onChange} template={initialYAML} {...(next && { resourceObjPath: () => next })} />;
};
